...
(use-package rainbow-mode
  :ensure t
  :config
  (define-global-minor-mode rainbow rainbow-mode (lambda () (rainbow-mode 1)))
  (rainbow 1)
  )
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rainbow-mode ranger helm helm-spotify-plus multi evil-magit magit dumb-jump indent-guid indent-guide indent-guide-mode indent-guide-mmode aggressive-indent org-bullets neotree auto-complete web-mode evil use-package))))
(custom-set-faces
