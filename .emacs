...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flycheck company flycheck-rtags company-rtags helm-rtags cmake-ide rtags projectile compagny xresources-theme evil-org rainbow-mode ranger helm helm-spotify-plus multi evil-magit magit dumb-jump indent-guid indent-guide indent-guide-mode indent-guide-mmode aggressive-indent org-bullets neotree auto-complete web-mode evil use-package))))
(custom-set-faces
